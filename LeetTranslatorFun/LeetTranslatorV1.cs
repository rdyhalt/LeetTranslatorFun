...
namespace Translator
{
  public static class Leet2
  {
    ...
    /// <param name="alternate">Use alternate translation</param>
    /// <returns>Leet translated text</returns>
    public static string ToLeet(this string text, int degree = 30, bool alternate = false)
    {
      return Translate(text, degree, alternate);
    }
    ...
    /// <param name="alternate">Use alternate translation</param>
    /// <returns>Leet translated text</returns>
    public static string Translate(string text, int degree = 30, bool alternate = false)
    {
